...
@section('main-content')
    ...
    <!-- Product Style -->
      <!-- Color Filter -->
 <!-- Color Filter -->
 <form id="colorFilterForm" method="GET" action="{{ route('color.filter') }}">
            ...
            @foreach ($colors as $color)
                <div class="form-check me-2">
                    <input type="checkbox" name="color[]" value="{{ $color }}" 
                        ...
                        {{ in_array($color, request()->input('color', [])) ? 'checked' : '' }}>
    ...
    @foreach (request()->except('color') as $key => $value)
        @if(is_array($value))
            @foreach ($value as $v)
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="single-product">
                                            ...
                                            <div class="product-content">
                                                ...
                                                <del style="padding-left:4%;">${{number_format($product->sell_price,2)}}</del>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                        <div class="quickview-content">
                                            ...
                                            @php
                                                $after_discount=($product->sell_price-($product->sell_price*$product->discount)/100);
                                            @endphp
                                            <h3><small><del class="text-muted">${{number_format($product->sell_price,2)}}</del></small>    ${{number_format($after_discount,2)}}  </h3>
