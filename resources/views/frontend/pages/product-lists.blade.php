							...
							<div class="shop-sidebar">
								...
								<div class="single-widget range">
									...
									{{-- <ul class="check-box-list">
										<li>
											<label class="checkbox-inline" for="1"><input name="news" id="1" type="checkbox">Qar 20 - Qar 50<span class="count">(3)</span></label>
										</li>
										<li>
											<label class="checkbox-inline" for="2"><input name="news" id="2" type="checkbox">Qar 50 - Qar 100<span class="count">(5)</span></label>
										</li>
										<li>
											<label class="checkbox-inline" for="3"><input name="news" id="3" type="checkbox">Qar 100 - Qar 250<span class="count">(8)</span></label>
										</li>
									</ul> --}}
								</div>
								<!--/ End Shop By Price -->
											...
											<div class="row">
												...
												<div class="col-lg-8 col-md-6 col-12">
													<div class="list-content">
														...
														<a href="javascript:void(0)" class="btn cart btn-primary" data-id="{{$product->id}}">Buy Now!</a>
													</div>
												</div>
											</div>
										</div>
