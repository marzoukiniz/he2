  ...
  <div class="swiper-container slideshow">
    ...
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide slide">
          <div class="slide-image" style="background-image: url(/backend/img/bn1.png)"></div>
          <span class="slide-title">Meer Hair Era</span>
        </div>
      
        <div class="swiper-slide slide">
          <div class="slide-image" style="background-image: url(/backend/img/bn4.png"></div>
          <span class="slide-title">Ocean  of Hair </span>
        </div>
      
      <div class="swiper-slide slide">
          <div class="slide-image" style="background-image: url(/backend/img/bn3.png"></div>
          <span class="slide-title">We are the only brand in Qatar</span>
        </div>
    ...
    <div class="slideshow-navigation">
        <div class="slideshow-navigation-button prev"><span class=" ">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M8.3685 12L13.1162 3.03212L14.8838 3.9679L10.6315 12L14.8838 20.0321L13.1162 20.9679L8.3685 12Z"></path></svg>
        </span>
    </div>
        <div class="slideshow-navigation-button next"><span class=""><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M15.6315 12L10.8838 3.03212L9.11622 3.9679L13.3685 12L9.11622 20.0321L10.8838 20.9679L15.6315 12Z"></path></svg></span></div>
    </div>
            ...
            <div class="col-12">
                <div class="product-info">
                    <div class="nav-main">
                        ...
                        <ul class="nav nav-tabs filter-tope-group" id="myTab" role="tablist">
                            ...
                            @endphp
                            @if($categories)
                                <button class="btn-item" data-filter="*">All Products</button>
                ...
                style="background-color: {{ $color->color }};">
                                            ...
                                            <div class="product-price">
                                                ...
                                                <del style="padding-left:4%;">Qar {{ number_format($product->sell_price, 2) }}</del>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<div class="shop-services container section home">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-service">
                    ...
                    <div class="serv-desc">
                        <h4 class="title">{{ __('fast_delivery') }} </h4>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-service">
                    ...
                    <div class="serv-desc">
                        <h4 class="title">{{ __('24_7_service') }} </h4>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-service">
                    ...
                    <div class="serv-desc">
                        <h4 class="title">{{ __('special_offers') }} </h4>
                    ...
                    @foreach($product_lists as $product)
                        ...
                        <div class="single-product">
                            ...
                            <div class="product-content">
                                ...
                                <div class="product-price">
                                    <span class="old">Qar {{number_format($product->sell_price,2)}}</span>
                                    @php
                                    $after_discount=($product->sell_price-($product->sell_price*$product->discount)/100)
                                    @endphp
                                    <span>Qar {{number_format($after_discount,2)}}</span>
            ...
            <div class="col-12">
                <div class="owl-carousel popular-slider">
                    @foreach($brands as $brand)
                        ...
                        <div class="single-product">
                            <div class="product-img"> 
                            <img class="default-img" src="{{$brand->image}}" alt="{{$brand->title}}">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                    <div class="quickview-content">
                                        ...
                                        @php
                                            $after_discount=($product->sell_price-($product->sell_price*$product->discount)/100);
                                        @endphp
                                        <h3><small><del class="text-muted">Qar {{number_format($product->sell_price,2)}}</del></small>    ${{number_format($after_discount,2)}}  </h3>
...
// The Slideshow class.
// The Slideshow class.
// Load Charming.js dynamically if it's missing
if (typeof charming === "undefined") {
    let script = document.createElement("script");
    script.src = "https://cdn.jsdelivr.net/npm/charming@1.0.1/charming.min.js";
    script.onload = () => console.log("Charming.js loaded!");
    document.head.appendChild(script);
}
 
document.addEventListener("DOMContentLoaded", function () {
    if (typeof charming === "undefined") {
        console.error("Charming.js not found. Make sure the script is loaded.");
    } else {
        const slideshowEl = document.querySelector('.slideshow');
        if (slideshowEl) new Slideshow(slideshowEl);
    }
});
...
class Slideshow {
    ...
    init() {
        ...
        if (this.DOM.slideTitle.length === 0) {
            console.warn("No .slide-title elements found.");
        } else {
    ...
    animate(direction = 'next') {
        ...
        if (!this.DOM.activeSlide) return;

        this.DOM.activeSlideImg = this.DOM.activeSlide.querySelector('.slide-image');
        this.DOM.activeSlideTitle = this.DOM.activeSlide.querySelector('.slide-title');

        if (this.DOM.activeSlideTitle) {
            this.DOM.activeSlideTitleLetters = this.DOM.activeSlideTitle.querySelectorAll('span') || [];
            this.DOM.activeSlideTitleLetters = direction === "next" ? this.DOM.activeSlideTitleLetters : [...this.DOM.activeSlideTitleLetters].reverse();
    ...
    animatePagination(swiper, paginationEl) {
        ...
        if (!this.DOM.activePaginationItem) return;
